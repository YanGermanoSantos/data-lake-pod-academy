...
SPARK_STEPS = [
    {
        ...
        'HadoopJarStep': {
            ...
            'Args': [
                ...
                's3://pod-academy-lake-370943306683/0004_codes/lake/products/product-processing-lake.py'
            ],
        }
    }
]
...
@dag(
    dag_id='products_process_data_taskflow',
