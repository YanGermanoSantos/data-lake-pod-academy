...
JOB_FLOW_OVERRIDES = {
    'Name': f'0002_process_curated_{SUBJECT}_lake',
...
SPARK_STEPS = [
    {
        ...
        'HadoopJarStep': {
            ...
            'Args': [
                ...
                'https://pod-academy-lake-370943306683.s3.us-east-1.amazonaws.com/0004_codes/book/book-lake.py'
            ],
        }
    }
]
...
@dag(
    dag_id='book_process_data_taskflow',
